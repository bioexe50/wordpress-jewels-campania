...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'itinc' ),
				'change'       => esc_html__( 'Change image', 'itinc' ),
				'default'      => esc_html__( 'Default', 'itinc' ),
				'remove'       => esc_html__( 'Remove', 'itinc' ),
				'placeholder'  => esc_html__( 'No image selected', 'itinc' ),
				'frame_title'  => esc_html__( 'Select image', 'itinc' ),
				'frame_button' => esc_html__( 'Choose image', 'itinc' ),
			)
		);
	}
