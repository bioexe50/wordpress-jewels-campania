...
(function($) {
    ...
    var AuleBooking = {
        ...
        config: {
            ...
            settings: prenotazione_aule_ssm_ajax.settings,
            strings: prenotazione_aule_ssm_ajax.strings
        },
        ...
        initializeCalendars: function() {
            ...
            $('.prenotazione-aule-ssm-calendar').each(function() {
                var $calendar = $(this);
                var auleId = $calendar.closest('.prenotazione-aule-ssm-wrapper').data('aula-id');
