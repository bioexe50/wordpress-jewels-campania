 ...
 */
class THSN_ClientElement extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'thsn_client_element';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'ITinc Client Logo Element', 'itinc' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'from_category',
			[
				'label' => esc_attr__( 'Show Post from selected Client Category?', 'itinc' ),
		...
		$this->add_control(
			'sortable',
			[
				'label' => esc_attr__( 'Show Sortable Client Category ?', 'itinc' ),
				'description' => esc_attr__( 'Select YES to show sortable Client Category.', 'itinc' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'itinc' ),
				'label_off' => esc_attr__( 'No', 'itinc' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Client View Style', 'itinc' ),
				'description'	=> esc_attr__( 'Slect Client View style.', 'itinc' ),
				'type'			=> 'thsn_imgselect',
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> '1',
				'options'		=> thsn_element_template_list( 'client', true ),
			]
		);
		$this->end_controls_section();
		...
		if ( $posts->have_posts() ) {
			...
			<div class="thsn-ele-header-area">
				...
				if( function_exists('thsn_sortable_category') ){
					$sortable_html = thsn_sortable_category( $settings, 'thsn-client-group' );
	...
	protected function select_category() {
		$category = get_terms( array( 'taxonomy' => 'thsn-client-group', 'hide_empty' => false ) );
	  	$cat = array();
...
Plugin::instance()->widgets_manager->register( new THSN_ClientElement() );