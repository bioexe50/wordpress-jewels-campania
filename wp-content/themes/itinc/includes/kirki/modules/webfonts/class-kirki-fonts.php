...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'itinc' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'itinc' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'itinc' ),
			'200'       => esc_html__( 'Light 200', 'itinc' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'itinc' ),
			'300'       => esc_html__( 'Book 300', 'itinc' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'itinc' ),
			'400'       => esc_html__( 'Normal 400', 'itinc' ),
			'regular'   => esc_html__( 'Normal 400', 'itinc' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'itinc' ),
			'500'       => esc_html__( 'Medium 500', 'itinc' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'itinc' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'itinc' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'itinc' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'itinc' ),
			'700'       => esc_html__( 'Bold 700', 'itinc' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'itinc' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'itinc' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'itinc' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'itinc' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'itinc' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'itinc' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'itinc' ),
		);
	}
