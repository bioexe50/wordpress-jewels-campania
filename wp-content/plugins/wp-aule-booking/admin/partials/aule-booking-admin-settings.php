...
<div class="wrap">
    <h1 class="wp-heading-inline">
        ⚙️ <?php _e('Impostazioni Plugin', 'aule-booking'); ?>
    </h1>

    <?php if (!empty($_GET['updated'])): ?>
        <div class="notice notice-success is-dismissible">
            <p><?php _e('Impostazioni salvate correttamente.', 'aule-booking'); ?></p>
        </div>
    <?php endif; ?>

    <?php if (!empty($_GET['error'])): ?>
        <div class="notice notice-error is-dismissible">
            <p><?php _e('Si è verificato un errore durante il salvataggio.', 'aule-booking'); ?></p>
        </div>
    <?php endif; ?>

    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" class="settings-form">
        <?php wp_nonce_field('aule_booking_settings_nonce'); ?>
        <input type="hidden" name="action" value="aule_booking_save_settings">

        <!-- Navigazione a tab -->
        <div class="nav-tab-wrapper">
            <a href="#general" class="nav-tab nav-tab-active" data-target="#general-settings">
                🏢 <?php _e('Generale', 'aule-booking'); ?>
            </a>
        ...
        <div id="general-settings" class="tab-content">
            <div class="settings-section">
                <h2><?php _e('Configurazione Generale', 'aule-booking'); ?></h2>
                <p class="description">
                    <?php _e('Impostazioni base per il funzionamento del plugin.', 'aule-booking'); ?>
                </p>

                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="conferma_automatica"><?php _e('Conferma Automatica', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <label for="conferma_automatica">
                                ...
                                <?php _e('Conferma automaticamente tutte le prenotazioni', 'aule-booking'); ?>
                            </label>
                            <p class="description">
                                <?php _e('Se disabilitato, le prenotazioni rimarranno in attesa di approvazione manuale.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="email_notifica_admin"><?php _e('Email Amministratori', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="text"
                            ...
                            <p class="description">
                                <?php _e('Email degli amministratori che riceveranno notifiche (separate da virgola).', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        <div id="booking-settings" class="tab-content" style="display: none;">
            <div class="settings-section">
                <h2><?php _e('Regole Prenotazioni', 'aule-booking'); ?></h2>
                <p class="description">
                    <?php _e('Configura le limitazioni e regole per le prenotazioni.', 'aule-booking'); ?>
                </p>

                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="giorni_prenotazione_futura_max"><?php _e('Giorni Futuri Max', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="number"
                                   ...
                                   max="365"
                                   class="small-text">
                            <label for="giorni_prenotazione_futura_max"><?php _e('giorni', 'aule-booking'); ?></label>
                            <p class="description">
                                <?php _e('Numero massimo di giorni in futuro per cui è possibile prenotare.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="ore_anticipo_prenotazione_min"><?php _e('Ore Anticipo Min', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="number"
                                   ...
                                   max="168"
                                   class="small-text">
                            <label for="ore_anticipo_prenotazione_min"><?php _e('ore', 'aule-booking'); ?></label>
                            <p class="description">
                                <?php _e('Numero minimo di ore di anticipo richieste per una prenotazione.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="max_prenotazioni_per_utente_giorno"><?php _e('Max Prenotazioni/Giorno', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="number"
                                   ...
                                   max="20"
                                   class="small-text">
                            <label for="max_prenotazioni_per_utente_giorno"><?php _e('prenotazioni', 'aule-booking'); ?></label>
                            <p class="description">
                                <?php _e('Numero massimo di prenotazioni per utente per giorno.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        <div id="email-settings" class="tab-content" style="display: none;">
            <div class="settings-section">
                <h2><?php _e('Template Email', 'aule-booking'); ?></h2>
                <p class="description">
                    <?php _e('Personalizza i template delle email automatiche. Usa i placeholder: {nome_aula}, {data_prenotazione}, {ora_inizio}, {ora_fine}, {nome_richiedente}, {cognome_richiedente}, {email_richiedente}, {motivo_prenotazione}, {codice_prenotazione}, {note_admin}', 'aule-booking'); ?>
                </p>

                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="template_email_conferma"><?php _e('Email Conferma', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description">
                                <?php _e('Template email inviata all\'utente quando la prenotazione viene confermata.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="template_email_rifiuto"><?php _e('Email Rifiuto', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description">
                                <?php _e('Template email inviata all\'utente quando la prenotazione viene rifiutata.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="template_email_admin"><?php _e('Email Admin', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description">
                                <?php _e('Template email inviata agli amministratori per nuove prenotazioni.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <div class="email-preview-section">
                    <h3><?php _e('Anteprima Email', 'aule-booking'); ?></h3>
                    <div class="email-preview-controls">
                        <select id="email-preview-type">
                            <option value="conferma"><?php _e('Conferma', 'aule-booking'); ?></option>
                            <option value="rifiuto"><?php _e('Rifiuto', 'aule-booking'); ?></option>
                            <option value="admin"><?php _e('Admin', 'aule-booking'); ?></option>
                        </select>
                        <button type="button" id="preview-email" class="button"><?php _e('Genera Anteprima', 'aule-booking'); ?></button>
                    </div>
        ...
        <div id="security-settings" class="tab-content" style="display: none;">
            <div class="settings-section">
                <h2><?php _e('Sicurezza e Protezione', 'aule-booking'); ?></h2>
                <p class="description">
                    <?php _e('Configura le misure di sicurezza per proteggere il sistema dalle prenotazioni spam.', 'aule-booking'); ?>
                </p>

                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="abilita_recaptcha"><?php _e('reCAPTCHA v3', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <label for="abilita_recaptcha">
                                ...
                                <?php _e('Abilita protezione reCAPTCHA', 'aule-booking'); ?>
                            </label>
                            <p class="description">
                                <?php _e('Protegge il form di prenotazione da spam e bot automatici.', 'aule-booking'); ?>
                                <a href="https://www.google.com/recaptcha/" target="_blank"><?php _e('Ottieni le chiavi', 'aule-booking'); ?></a>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr class="recaptcha-field">
                        <th scope="row">
                            <label for="recaptcha_site_key"><?php _e('Site Key', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="text"
                            ...
                            <p class="description">
                                <?php _e('Chiave pubblica reCAPTCHA (visibile nel frontend).', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr class="recaptcha-field">
                        <th scope="row">
                            <label for="recaptcha_secret_key"><?php _e('Secret Key', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="password"
                            ...
                            <p class="description">
                                <?php _e('Chiave privata reCAPTCHA (per verifica server-side).', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <div class="recaptcha-test-section" style="margin-top: 20px;">
                    <h3><?php _e('Test Configurazione', 'aule-booking'); ?></h3>
                    <button type="button" id="test-recaptcha" class="button" disabled>
                        🧪 <?php _e('Testa reCAPTCHA', 'aule-booking'); ?>
                    </button>
        ...
        <div id="appearance-settings" class="tab-content" style="display: none;">
            <div class="settings-section">
                <h2><?php _e('Personalizzazione Colori', 'aule-booking'); ?></h2>
                <p class="description">
                    <?php _e('Personalizza i colori utilizzati nel calendario e negli stati delle prenotazioni.', 'aule-booking'); ?>
                </p>

                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="colore_slot_libero"><?php _e('Slot Liberi', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="color"
                            ...
                            <label for="colore_slot_libero" class="color-label">
                                <?php _e('Colore per slot disponibili', 'aule-booking'); ?>
                            </label>
                            <p class="description">
                                <?php _e('Colore utilizzato nel calendario per indicare slot disponibili.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="colore_slot_occupato"><?php _e('Slot Occupati', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="color"
                            ...
                            <label for="colore_slot_occupato" class="color-label">
                                <?php _e('Colore per slot occupati', 'aule-booking'); ?>
                            </label>
                            <p class="description">
                                <?php _e('Colore utilizzato nel calendario per prenotazioni confermate.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="colore_slot_attesa"><?php _e('Slot In Attesa', 'aule-booking'); ?></label>
                        </th>
                        <td>
                            <input type="color"
                            ...
                            <label for="colore_slot_attesa" class="color-label">
                                <?php _e('Colore per slot in attesa', 'aule-booking'); ?>
                            </label>
                            <p class="description">
                                <?php _e('Colore utilizzato nel calendario per prenotazioni in attesa di approvazione.', 'aule-booking'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <div class="color-preview-section">
                    <h3><?php _e('Anteprima Colori', 'aule-booking'); ?></h3>
                    <div class="color-preview-grid">
                        <div class="color-preview-item">
                            ...
                            <span><?php _e('Slot Libero', 'aule-booking'); ?></span>
                        </div>
                        <div class="color-preview-item">
                            ...
                            <span><?php _e('Slot Occupato', 'aule-booking'); ?></span>
                        </div>
                        <div class="color-preview-item">
                            ...
                            <span><?php _e('Slot In Attesa', 'aule-booking'); ?></span>
                        </div>
                    </div>
                    <button type="button" id="reset-colors" class="button">
                        🔄 <?php _e('Ripristina Colori Default', 'aule-booking'); ?>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="settings-footer">
            <?php submit_button(__('Salva Impostazioni', 'aule-booking'), 'primary', 'submit', false); ?>
            <button type="button" class="button button-secondary" id="reset-settings">
                🔄 <?php _e('Ripristina Default', 'aule-booking'); ?>
            </button>
            <button type="button" class="button button-secondary" id="export-settings">
                📤 <?php _e('Esporta Configurazione', 'aule-booking'); ?>
            </button>
            <button type="button" class="button button-secondary" id="import-settings">
                📥 <?php _e('Importa Configurazione', 'aule-booking'); ?>
            </button>
        </div>
    </form>
...
jQuery(document).ready(function($) {
    ...
    $('.nav-tab').on('click', function(e) {
        ...
        // Salva tab attivo
        localStorage.setItem('aule_booking_active_settings_tab', target);
    });

    // Ripristina tab attivo
    var activeTab = localStorage.getItem('aule_booking_active_settings_tab');
    ...
    $('#reset-settings').on('click', function() {
        if (!confirm('<?php esc_js(_e('Ripristinare tutte le impostazioni ai valori predefiniti?', 'aule-booking')); ?>')) {
            return;
        }
    ...
    $('#export-settings').on('click', function() {
        ...
        var exportFileDefaultName = 'aule-booking-settings-' + new Date().toISOString().slice(0,10) + '.json';
    ...
    setInterval(function() {
        var formData = $('.settings-form').serialize();
        localStorage.setItem('aule_booking_settings_draft', formData);
    }, 30000);

    // Ripristina draft se presente
    var draft = localStorage.getItem('aule_booking_settings_draft');
    if (draft && confirm('<?php esc_js(_e('Ripristinare le modifiche non salvate?', 'aule-booking')); ?>')) {
        // Ripristina draft
