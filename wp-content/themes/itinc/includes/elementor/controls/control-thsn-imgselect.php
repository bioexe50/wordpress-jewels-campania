 ...
 * @since 1.0.0
 */
class THSN_imgselect extends \Elementor\Base_Data_Control {
	...
	public function get_type() {
		return 'thsn_imgselect';
    }

    public function enqueue() {
		// Styles
		wp_register_style( 'thsn-elementor-base', get_template_directory_uri() . '/includes/elementor-base.css' );
		wp_enqueue_style( 'thsn-elementor-base' );
	}
