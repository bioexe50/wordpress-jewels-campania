...
(function($) {
    ...
    var AuleBookingAdmin = {
         ...
         */
        config: {
            ajaxUrl: aule_booking_admin_ajax.ajax_url,
            nonce: aule_booking_admin_ajax.nonce,
            strings: aule_booking_admin_ajax.strings
        },
        ...
        setupTabs: function() {
            $('.nav-tab-wrapper').on('click', '.nav-tab', function(e) {
                ...
                // Salva tab attivo
                localStorage.setItem('aule_booking_active_tab', target);
            });

            // Ripristina tab attivo
            var activeTab = localStorage.getItem('aule_booking_active_tab');
