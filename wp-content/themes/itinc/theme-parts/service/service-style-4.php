...
// Read More text
if( !isset($more_text) ){
	$more_text = esc_attr__('More Details','itinc');
}
?>
	...
	<div class="themesion-box-content">
		<div class="themesion-box-content-inner">
			<div  class="d-flex align-items-center ">
				<div class="thsn-service-title-box">
			...
			<div class="thsn-service-btn">
				<a class="btn-arrow" href="<?php the_permalink(); ?>"><span class="thsn-btn-text"><?php echo thsn_esc_kses($more_text); ?></span><i class="thsn-base-icon-right-arrow"></i></a>
			</div>
		</div>
	</div>
</div>