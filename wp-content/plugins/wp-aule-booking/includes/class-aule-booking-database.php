...
class Aule_Booking_Database {
    ...
    public function __construct() {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->table_aule = $wpdb->prefix . 'aule_booking_aule';
        $this->table_slot = $wpdb->prefix . 'aule_booking_slot_disponibilita';
        $this->table_prenotazioni = $wpdb->prefix . 'aule_booking_prenotazioni';
        $this->table_impostazioni = $wpdb->prefix . 'aule_booking_impostazioni';
    }
