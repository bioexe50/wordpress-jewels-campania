...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'itinc' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'itinc' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'itinc' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'itinc' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'itinc' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'itinc' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'itinc' ); ?>',
} );
#>
