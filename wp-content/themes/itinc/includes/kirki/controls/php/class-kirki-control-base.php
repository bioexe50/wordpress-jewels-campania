	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'itinc' ),
				'remove'               => esc_html__( 'Remove', 'itinc' ),
				'default'              => esc_html__( 'Default', 'itinc' ),
				'selectFile'           => esc_html__( 'Select File', 'itinc' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'itinc' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'itinc' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'itinc' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'itinc' ),
			)
		);
